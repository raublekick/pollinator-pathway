          ...
          <div class="row">
            ...
            <div class="col-auto">
              <div class="form-check form-check-inline">
                ...
                />
                <label class="form-check-label" for="checkCommercial">
                  Commercially available</label
                >
              </div>
            ...
            <div class="col-auto">
              <div class="form-check form-check-inline">
                ...
                />
                <label class="form-check-label" for="checkHummingbirds"
                  >Attracts hummingbirds</label
                >
              </div>
